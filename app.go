...
import (
	...
	"github.com/truefrog/go_realchat/v2/config"
	"github.com/truefrog/go_realchat/v2/database"
	"github.com/truefrog/go_realchat/v2/mode"
	"github.com/truefrog/go_realchat/v2/model"
	"github.com/truefrog/go_realchat/v2/router"
	"github.com/truefrog/go_realchat/v2/runner"
)
...
func main() {
	...
	fmt.Println("Starting 1.0 version", vInfo.Version+"@"+BuildDate)
